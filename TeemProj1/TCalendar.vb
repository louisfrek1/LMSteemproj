...
Public Class TCalendar
    ...
    End Sub
    Private Sub TCalendar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        GenerateDayPanel(42)
    ...
    Private Sub AddNewAppointment(ByVal sender As Object, e As EventArgs)
        ...
        If day <> 0 Then
            Tcalenmon.datepcker.Value = New Date(currentDate.Year, currentDate.Month, CType(sender, Guna2Button).Tag)
            While Me.Panel1.Controls.Count > 0
                Me.Panel1.Controls(0).Dispose()
            End While
            switchPanelTCalen(Tcalenmon)
            DisplayCurrentDate()
        End If
    End Sub
